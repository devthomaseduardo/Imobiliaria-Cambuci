...
import { IconChartUp, IconPortfolio, IconShieldCheck, IconSpark } from "@/components/icons/JtgIcons";
...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <div className="relative min-h-[85vh] w-full overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 sm:px-6 text-center">
        ...
        >
          ...
          <h1 className="mb-6 text-4xl sm:text-5xl font-extrabold tracking-tight text-white md:text-7xl">
            {title}
          </h1>
          <p className="mb-10 text-base sm:text-lg text-slate-300 md:text-xl lg:px-20">
            {subtitle}
          </p>
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 md:grid-cols-4">
            {[
              { label: "Ativos Curados", value: "240+", icon: IconPortfolio },
              { label: "Novos Sinais", value: "18", icon: IconSpark },
              { label: "Risco Controlado", value: "2.4%", icon: IconShieldCheck },
              { label: "Performance", value: "6.8%", icon: IconChartUp },
            ].map((stat, i) => (
